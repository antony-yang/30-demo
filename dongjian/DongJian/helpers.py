...
def crc_for_dnp(string):
    return libscrc.dnp(string)

def ipv6_checksum(msg):
    """
    Return IPv6 checksum of msg.
...
def get_boofuzz_version(boofuzz_class):
    ...
    :param boofuzz_class: Any DongJian class in the same dir as the __init__ class.
