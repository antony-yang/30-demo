...
from .blocks import Block, Checksum, Repeat, Request, REQUESTS, Size, SizeBit
...
from .sessions_cov import CovSession
...
def s_checksum(
    ...
    checksum = Checksum(
        ...
        fuzzable,
        name,
        ipv6_block_name=ipv6_block_name,
...
def s_string(value, size=-1, padding=b"\x00", encoding="ascii", fuzzable=True, max_len=None, name=None):
    """
