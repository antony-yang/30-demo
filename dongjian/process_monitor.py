...
from DongJian.constants import DEFAULT_PROCMON_PORT
#from DongJian.utils.debugger_thread_pydbg import DebuggerThreadPydbg
from DongJian.utils.debugger_thread_simple import DebuggerThreadSimple
from DongJian.utils.debugger_thread_pykd import DebuggerThreadPykd
from DongJian.utils.process_monitor_pedrpc_server import ProcessMonitorPedrpcServer
...
def serve_procmon(port, crash_bin, proc_name, ignore_pid, log_level):
    with ProcessMonitorPedrpcServer(
        ...
        debugger_class=DebuggerThreadPykd,
...
#                       default='DongJian-crash-bin', metavar='FILENAME')
...
if __name__ == "__main__":
    #go("DongJian-crash-bin",0,1,None,DEFAULT_PROCMON_PORT)
    go()