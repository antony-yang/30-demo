...
from DongJian import helpers
from DongJian.constants import DEFAULT_PROCMON_PORT
from DongJian.utils.debugger_thread_unix import DebuggerThreadUnix
...
def serve_procmon(port, crash_bin, proc_name, ignore_pid, log_level, coredump_dir):
    with ProcessMonitorPedrpcServer(
        ...
        debugger_class=DebuggerThreadUnix,
        proc_name=proc_name,
...
if __name__ == "__main__":
    go("DongJian-crash-bin",0,1,None,DEFAULT_PROCMON_PORT,"coredumps")
    #go()
