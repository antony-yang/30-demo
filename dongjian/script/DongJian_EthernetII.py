...
def fuzz(start_cmds, proc_name, target_ip, pport, dport, *args, **kwargs):
    ...
    s_block_start(name="EtheII", group="type")
    s_static(value=transtomac(kwargs["dst_mac"]), name="dst")
    s_static(value=get_mac_addr(), name="src")
    s_group(values=["\x06\x00","\x06\x60","\x06\x61","\x08\x00","\x08\x01","\x08\x02","\x08\x03","\x08\x04","\x08\x05","\x08\x06",
                    "\x08\x08","\x65\x59","\x80\x35","\x80\x37","\x80\x9B","\x80\xD5","\x80\xF3","\x81\x00","\x81\x37","\x81\x4C",
                    "\x86\xDD","\x88\x09","\x88\x0B","\x88\x0C","\x88\x47","\x88\x48","\x88\x63","\x88\x64","\x88\xBB","\x88\xCC",
                    "\x8E\x88","\x90\x00","\x91\x00","\x92\x00"], name="type", default_value="\x08\x00")
    s_block_start(name="frame body")
    s_random(name="body", value="\x00"*46, min_length=46, max_length=1500, num_mutations=10000)
