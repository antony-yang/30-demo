...
def fuzz(start_cmds, proc_name, target_ip, pport, dport, *args, **kwargs):
    ...
    # s_delim(" ")
    # s_dword(7000, output_format="ascii")
    # s_delim(" ")
    # s_dword(3, output_format="ascii")
    # s_static("\r\n")
    #
    # # -----------------------------------------------------------------------------
    ...
    # s_string("127.0.0.1")
    # s_delim(" ")
    # s_dword(6666, output_format="ascii")
    # s_static("\r\n")
    #
    # # -----------------------------------------------------------------------------
    ...
    # s_string("test")
    # s_delim(" ")
    # s_dword(500, output_format="ascii")
    # s_static("\r\n")
    #
    # # -----------------------------------------------------------------------------
    ...
    # s_string("test")
    # s_delim(" ")
    # s_dword(1293840000, output_format="ascii")
    # s_static("\r\n")
    #
    # # -----------------------------------------------------------------------------
    ...
    # s_dword(1, output_format="ascii")
    # s_delim(".")
    # s_dword(10, output_format="ascii")
    # s_static("\r\n")
    #
    # # -----------------------------------------------------------------------------
    ...
    # s_dword(0, output_format="ascii")
    # s_delim(" ")
    # s_dword(1, output_format="ascii", signed=True)
    # s_static("\r\n")
    #
    ...
    # for cmd in cmds:
    #     sess.connect(s_get(cmd))
    sess.connect(s_get("AUTH"))
    sess.connect(s_get("AUTH"), s_get("SET"))
    sess.fuzz()
