...
def fuzz(start_cmds, proc_name, target_ip, pport, dport, *args, **kwargs):
    ...
    with s_block('hdr'):   # ISAKMP
        ...
        s_static(value='\x10', name='version')
        s_static(value='\x02', name='exchange_type')
        s_static(value='\x00', name='flags')
        s_static(value='\x00'*4, name='message_id')
        s_size(block_name='payloads', offset=28, length=4, endian='>', name='length')
